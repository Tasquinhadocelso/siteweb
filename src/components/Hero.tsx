...
export default function Hero({ language }: HeroProps) {
  ...
  return (
    <section className="relative h-[calc(100vh-122px)] overflow-hidden">
      {/* Background Image with subtle zoom animation */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat animate-subtle-zoom"
        style={{
          backgroundImage:
            'url("https://lh3.googleusercontent.com/pw/AP1GczPPPncAq6c-_iegwmMo8OGwLYd1XYCYaaj-5BzbcwoxazHezOeUBGDhy3zI2K3P1-x-FejmUBuEZW02KoXhrG9GSdRHaxWcSUgpFflQNrpKm94bK-DM4Mbi_yuEbwsTYrEg4XOmabDJM8ZBvalrqlq6=w2939-h1519-s-no-gm")',
